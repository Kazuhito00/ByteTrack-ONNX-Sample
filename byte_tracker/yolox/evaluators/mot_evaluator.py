...
from byte_tracker.yolox.utils import (
    gather,
    is_main_process,
    postprocess,
    synchronize,
...
from byte_tracker.yolox.sort_tracker.sort import Sort
from byte_tracker.yolox.deepsort_tracker.deepsort import DeepSort
from byte_tracker.yolox.motdt_tracker.motdt_tracker import OnlineTracker
...
class MOTEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            '''
            try:
                from byte_tracker.yolox.layers import COCOeval_opt as COCOeval
            except ImportError:
